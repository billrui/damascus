...
// ── Main CashierPOS ───────────────────────────────────────────────────────────
export default function CashierPOS({ user, sales, setSales, batches, setBatches, openInvoices, setOpenInvoices, recipes, ingredients, holdList }) {
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", background: T.bg, fontFamily: T.font, color: T.textPrimary }}>
        ...
        <div style={{ width: 390, display: "flex", flexDirection: "column", background: T.surface, borderRight: `1px solid ${T.border}` }}>
          ...
          <div style={{ padding: "20px 20px 16px", borderBottom: `1px solid ${T.border}` }}>
            ...
            <div style={{ display: "flex", gap: 6, background: T.bg, borderRadius: 6, padding: 4 }}>
              {[["open","Open Invoices"],["all","All Today"]].map(([k,l]) => (
